...
class ClientController extends Controller
{
    ...
    public function SingleProduct($id){
        ...
        $related_products = Product::where('product_subcategory_id', $subcat_id)
        ->latest()->get();
    ...
    public function AddProductToCart(Request $request){
        ...
        return redirect()->route('addtocart')->with('message', 'Your item added
         to cart successfully!');
    }

    public function RemoveCartItem($id){
        Cart::findOrFail($id)->delete();
        return redirect()->route('addtocart')->with('message', 'Your item removed
    ...
    public function PlaceOrder(){
        ...
        return redirect()->route('pendingorders')->with('message', 'Your order placed
        successfully!');
    }
